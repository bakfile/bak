...
pub fn get_config() -> anyhow::Result<Rc<Config>> {
...
pub struct Config {
    ...
    pub bakfile_db_schema_version: u32,
...
impl fmt::Display for Config {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            ...
            bakfile database schema version {}
            located at {:?}",
            ...
            self.bakfile_db_schema_version,
...
impl Config {
    fn gen_default() -> Result<Config, SystemError> {
        Ok(Config {
            ...
            bakfile_db_schema_version: crate::util::DB_SCHEMA_VERSION,
            toml: None
        })
    }
    ...
    pub fn load(path: Option<&Path>) -> anyhow::Result<Config> {
        ...
        let out: Config = match i_file.parse::<toml_edit::DocumentMut>() {
            ...
            Ok(conf) => Config {
                ...
                bakfile_db_schema_version: conf["db_schema_version"].as_str().unwrap().parse::<u32>()?,
                toml: Some(conf)
            },
            Err(e) => {
    ...
    pub fn update_toml(&mut self) {
        ...
        toml["db_schema_version"] = Item::from(self.bakfile_db_schema_version.to_string());
